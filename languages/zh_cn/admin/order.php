<?php
    ...
    $_LANG['prev'] = '前一个订单';
    $_LANG['next'] = '后一个订单';
    $_LANG['print_order'] = '打印选中的订单';
    $_LANG['export_order'] = '导出选中的订单';
    $_LANG['print_shipping'] = '打印选中的快递单';
    $_LANG['batch_print_shipping'] = '批量打印快递单';
