<?php
    ...
    $_LANG['app_name'] = '云动商圈';
    $_LANG['cp_home'] = '控制面板';
    $_LANG['copyright'] = '版权所有 &copy; 2016-2035 中移铁通智能产品分公司，并保留所有权利。';
    ...
    $_LANG['01_rec'] = '推荐分销';
    $_LANG['02_order'] = '订单管理';
    $_LANG['03_members'] = '用户管理';
    $_LANG['04_promotion'] = '促销活动';
    $_LANG['05_cat_and_goods'] = '商品管理';
    $_LANG['06_banner'] = '广告展位';
    $_LANG['07_template'] = 'PC端界面';
    $_LANG['08_content'] = '文章精萃';
    $_LANG['09_wechat'] = '微信管家';
    ...
    $_LANG['53_suppliers_goods'] = '供货商商品';

    $_LANG['14_goods_export'] = '商品批量导出';

    $_LANG['50_virtual_card_list'] = '虚拟商品';
    ...
    $_LANG['09_delivery_order'] = '发货单';
    $_LANG['10_back_order'] = '退货单';
    ...
    /* 用户管理 */
    $_LANG['08_unreply_msg'] = '用户留言';
    $_LANG['03_users_list'] = '用户列表';
    $_LANG['04_users_add'] = '添加用户';
    $_LANG['05_user_rank_list'] = '用户等级';
    $_LANG['06_list_integrate'] = '用户整合';
    ...
    $_LANG['021_reg_fields'] = '用户注册选填内容';

    /* 模板管理 */
    $_LANG['02_template_select'] = '选择界面';
    $_LANG['03_template_setup'] = '模块显示';
    $_LANG['04_template_library'] = '样式编辑';
    $_LANG['mail_template_manage'] = '邮件模板';
    $_LANG['05_edit_languages'] = '语言包编辑';
    $_LANG['06_template_backup'] = '界面备份';
    /* 数据库管理 */
    ...
    $_LANG['aliSendSmsEdit'] = '编辑';
    $_LANG['aliSendSmsList'] = '大鱼短信模板';
    $_LANG['aliSendSmsConfig'] = '大鱼短信设置';
    $_LANG['aliSendSmsSend'] = '大鱼短信发送测试';

    $_LANG['affiliate'] = '推荐设置';
    $_LANG['affiliate_ck'] = '分成管理';
    $_LANG['danpin_tuiguang'] = '单品推广';
    $_LANG['zdy_parent'] = '推荐关系';
    $_LANG['user_account'] = '充值提现';
    $_LANG['user_account_manage'] = '资金管理';



    $_LANG['flashplay'] = '首页轮播';
    $_LANG['search_log'] = '搜索关键字';
    $_LANG['email_list'] = '邮件订阅';
...
//商创微信通
    $_LANG['wx_23lang'] = '语言设置';
    $_LANG['wx_22api'] = '对接微信';
    $_LANG['wx_21menu'] = '微信菜单';
    $_LANG['wx_20config'] = '微信设置';
    $_LANG['wx_19autoreg'] = '微信自动注册';
    $_LANG['wx_18bonus'] = '关注送红包';
    $_LANG['wx_17regmsg'] = '关注回复内容';
    $_LANG['wx_16keywords'] = '关键词自动回复';
    $_LANG['wx_15oauth'] = '微信OAuth';
    $_LANG['wx_14fun'] = '功能变量';


    $_LANG['wx_11tuijian_reply'] = '发展会员关注提醒';
    $_LANG['wx_10qr'] = '多功能二维码';
    $_LANG['wx_09order'] = '发货提醒';
    $_LANG['wx_08pay'] = '付款提醒';
    $_LANG['wx_07reorder'] = '订单提醒';
    $_LANG['wx_06fans'] = '粉丝管理';
    $_LANG['wx_05list'] = '推荐人列表';
    $_LANG['wx_04tuijian'] = '扫码引荐';
    $_LANG['wx_03zjd'] = '砸金蛋';
    $_LANG['wx_02dzp'] = '大转盘';
    $_LANG['wx_01prize'] = '抽奖规则';
    $_LANG['wx_00point'] = '赚积分';