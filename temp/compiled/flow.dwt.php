...
?>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="themes/ecmoban_tianmao2016/images/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout"><img src="themes/ecmoban_tianmao2016/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
            <ul class="clearfix" style="height:320px;">
              ...
              <li>
                ...
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/ecmoban_tianmao2016/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="submit"  value="加入购物车" style="padding:3px 10px;background:#dd2727; cursor: pointer; color:#FFF; border:0 none; outline:none;"></td>
            </tr>
            <?php endif; ?>
          </table>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/ecmoban_tianmao2016/images/bnt_subOrder.gif" />
