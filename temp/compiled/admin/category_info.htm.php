...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <!--</tr>-->
        ...
        <!--<td>-->
          <!--<input type="radio" name="is_top_show" value="1" <?php if ($this->_var['cat_info']['is_top_show'] != 0): ?> checked="true"<?php endif; ?>/> <?php echo $this->_var['lang']['yes']; ?>-->
          <!--<input type="radio" name="is_top_show" value="0" <?php if ($this->_var['cat_info']['is_top_show'] == 0): ?> checked="true"<?php endif; ?> /> <?php echo $this->_var['lang']['no']; ?>-->
        <!--</td>-->
      <!--</tr>	-->
	 <!--<tr>-->
