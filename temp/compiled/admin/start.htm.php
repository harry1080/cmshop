        ...
        <ul>
            <li class="item01">
                <div class="con_box clearfix">
                    ...
                    <div class="text"><h2><?php echo $this->_var['lang']['unconfirmed']; ?></h2>

                        <p><a href="order.php?act=list&composite_status=<?php echo $this->_var['status']['unconfirmed']; ?>"><?php echo $this->_var['order']['unconfirmed']; ?></a>
                        </p></div>
                </div>
            </li>
            <li class="item02">
                <div class="con_box clearfix">
                    ...
                    <div class="text"><h2><?php echo $this->_var['lang']['await_pay']; ?></h2>

                        <p><a href="order.php?act=list&composite_status=<?php echo $this->_var['status']['await_pay']; ?>"><?php echo $this->_var['order']['await_pay']; ?></a></p>
                    </div>
                </div>
            </li>
            <li class="item03">
                <div class="con_box clearfix">
                    ...
                    <div class="text"><h2><?php echo $this->_var['lang']['await_ship']; ?></h2>

                        <p><a href="order.php?act=list&composite_status=<?php echo $this->_var['status']['await_ship']; ?>"><?php echo $this->_var['order']['await_ship']; ?></a>
                        </p></div>
                </div>
            </li>
            <li class="item04">
                <div class="con_box clearfix">
                    ...
                    <div class="text"><h2><?php echo $this->_var['lang']['finished']; ?></h2>

                        <p><a href="order.php?act=list&composite_status=<?php echo $this->_var['status']['finished']; ?>"><?php echo $this->_var['order']['finished']; ?></a></p>
                    </div>
                </div>
            </li>
            <li class="item05">
                <div class="con_box clearfix">
                    ...
                    <div class="text clearfix"><h2><?php echo $this->_var['lang']['new_booking']; ?></h2>

                        <p><a href="goods_booking.php?act=list_all"><?php echo $this->_var['booking_goods']; ?></a></p></div>
                </div>
            </li>
            <li class="item06">
                <div class="con_box">
                    <div class="img"><img src="images/iconfont-yifahuo.png" width="30" height="30"/></div>
                    <div class="text"><h2><?php echo $this->_var['lang']['shipped_part']; ?></h2>

                        <p>
                            <a href="order.php?act=list&composite_status=<?php echo $this->_var['status']['shipped_part']; ?>"><?php echo $this->_var['order']['shipped_part']; ?></a>
                        </p></div>
                </div>
            </li>
            <li class="item07">
                <div class="con_box clearfix">
                    ...
                    <div class="text"><h2><?php echo $this->_var['lang']['new_reimburse']; ?></h2>

                        <p><a href="user_account.php?act=list&process_type=1&is_paid=0"><?php echo $this->_var['new_repay']; ?></a></p></div>
                </div>
            </li>
        </ul>
    </div>
...
<div class="list-div">
    <div class="order_count">
        <p style="position:absolute; margin:-1px 0 0 0;"><span class="tab_front" style="font-size:20px;"><strong><?php echo $this->_var['thismonth']; ?>月订单统计</strong></span>
        </p>
...
<div class="list-div">
    <div class="order_count">
        <p style="position:absolute; margin:-1px 0 0 0;"><span class="tab_front" style="font-size:20px;"><strong><?php echo $this->_var['thismonth']; ?>月销售额统计</strong></span>
        </p>
...
<script>
    ...
    //检查是否为正版
    Ajax.call('index.php?is_ajax=1&act=main_api', '', start_api, 'GET', 'TEXT', 'TRUE');
//    Ajax.call('cloud.php?is_ajax=1&act=cloud_remind', '', cloud_api, 'GET', 'JSON');
