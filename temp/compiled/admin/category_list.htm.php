...
?>
  <tr class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <!--<td width="10%"><span onclick="listTable.edit(this, 'edit_measure_unit', <?php echo $this->_var['cat']['cat_id']; ?>)">&lt;!&ndash; <?php if ($this->_var['cat']['measure_unit']): ?> &ndash;&gt;<?php echo $this->_var['cat']['measure_unit']; ?>&lt;!&ndash; <?php else: ?> &ndash;&gt;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!&ndash; <?php endif; ?> &ndash;&gt;</span></td>-->
