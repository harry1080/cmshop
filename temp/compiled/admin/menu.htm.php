...
?>
            ...
            <li class="collapse ico_<?php echo $this->_foreach['foo']['iteration']; ?>" key_data1="lis ico_<?php echo $this->_foreach['foo']['iteration']; ?>"
                key_data2="lis ico2_<?php echo $this->_foreach['foo']['iteration']; ?>"><a href="<?php echo $this->_var['menu']['action']; ?>" target="main-frame"><?php echo $this->_var['menu']['label']; ?></a>
            </li>
            <?php else: ?>
            <li class="collapse lis ico_<?php echo $this->_foreach['foo']['iteration']; ?>" key="<?php echo $this->_var['k']; ?>" name="menu"
                key_data1="lis ico_<?php echo $this->_foreach['foo']['iteration']; ?>"
                key_data2="lis ico2_<?php echo $this->_foreach['foo']['iteration']; ?>">
