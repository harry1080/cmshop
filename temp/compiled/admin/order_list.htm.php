...
<div class="form-div">
  <form action="javascript:searchOrder()" name="searchForm">
    ...
    <?php echo $this->_var['lang']['invoice_no']; ?><input name="invoice_no" type="text" id="invoice_no" size="15">
    ...
    <!--<a href="order.php?act=list&composite_status=<?php echo $this->_var['cs_await_ship']; ?>"><?php echo $this->_var['lang']['cs'][$this->_var['cs_await_ship']]; ?></a>-->
      <a href="javascript:;" class="c-btn3" onclick="order_to_excel()">导出excel</a>
  </form>
</div>
<script>
...
<?php if ($this->_var['full_page']): ?>
  <div>
    ...
    <input name="print_shopping" type="submit" id="btnSubmit6" value="<?php echo $this->_var['lang']['batch_print_shipping']; ?>" class="button" disabled="true" onclick="this.form.target = '_blank'" />
      <!-- 导出订单功能开始 -->
      <input name="export" type="submit" id="btnSubmit5" value="<?php echo $this->_var['lang']['export_order']; ?>" class="button" disabled="true" onclick="this.form.target = '_blank'" />
      <!-- 导出订单功能结束 -->
