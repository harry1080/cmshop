...
.login_logo{text-align:center; padding-bottom:30px;height: 50px}
...
<div class="login_box">
<div class="login_con">
<!--<div class="login_logo"><a href="www.mbizzone.com" target="_blank"><img src="images/logo.gif" /></a></div>-->
...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="320">
    <tr>
      <td height="90" align="center" valign="middle" style="font-size:25px; color:#333; font-family:'宋体';">系统管理中心</td>
    </tr>
    <tr>
      <td align="center" >
      	<table>
