...
?>
  <tr>
    ...
    <td align="center">
      ...
      <a href="../mobile/goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['mobileview']; ?>"><img src="images/icon_view.gif" width="21" height="21" border="0" /></a>
