...
?>
<dl>
  <dt> <img src="themes/ecmoban_tianmao2016/images/left_help_biao.gif"> <a href='<?php echo $this->_var['help_cat']['cat_id']; ?>' title="<?php echo $this->_var['help_cat']['cat_name']; ?>"><?php echo $this->_var['help_cat']['cat_name']; ?></a></dt>
