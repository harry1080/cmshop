...
?>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <p class="footer-nav">
                <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_41372500_1515031353');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_41372500_1515031353']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
                <a href="<?php echo $this->_var['nav_0_41372500_1515031353']['url']; ?>" <?php if ($this->_var['nav_0_41372500_1515031353']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_41372500_1515031353']['name']; ?></a> 
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
            </p>
            <?php endif; ?>
...
?>
            ...
            联系方式: <?php echo $this->_var['service_phone']; ?>
            <?php endif; ?> 
            <?php if ($this->_var['service_email']): ?> 
            电子邮件: <?php echo $this->_var['service_email']; ?>
            <?php endif; ?>
            </span>
            <div class="d-copyright">
               ...
               <p>网站备案：<?php echo $this->_var['icp_number']; ?></p>
            </div>
        </div>
    </div>
</div>
