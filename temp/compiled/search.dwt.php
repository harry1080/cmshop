   ...
   <?php if (isset ( $this->_var['goods_list'] )): ?>
     ...
     <ul class="goods_list">
        ...
        <?php if ($this->_var['intromode'] == 'best'): ?>
         ...
         <img src="themes/ecmoban_tianmao2016/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a></li>
         <li> <a href="javascript:;" onClick="javascript:display_mode('grid')">
         <img src="themes/ecmoban_tianmao2016/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a></li>
         <li> <a href="javascript:;" onClick="javascript:display_mode('text')">
         <img src="themes/ecmoban_tianmao2016/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;</li>
             <li>  <select name="sort">
              ...
              <li><input type="image" name="imageField" src="themes/ecmoban_tianmao2016/images/bnt_go.gif" alt="go"/></li>
