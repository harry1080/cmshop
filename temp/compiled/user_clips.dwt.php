      ...
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
         ...
         <?php if ($this->_var['action'] == 'default'): ?>
          ...
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           ...
           <img src="themes/ecmoban_tianmao2016/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
           <br /><br />
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/ecmoban_tianmao2016/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/ecmoban_tianmao2016/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
