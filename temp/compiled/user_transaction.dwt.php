...
?>
      ...
      <form name="addBouns" action="user.php" method="post" onSubmit="return addBonus()">
        <div style="padding: 15px;">
          <span style="*vertical-align: 7px;"><?php echo $this->_var['lang']['bonus_number']; ?></span>
...
?>
              <tr>
                ...
                <td width="120"><?php echo $this->_var['points']['value']; ?></td>
              </tr>
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </table></td>
            <td width="50%" valign="top" bgcolor="#FFFFFF"><table>
                ...
                <td width="120"><?php echo $this->_var['shop_points']['pay_points']; ?></td>
                    </tr>
              <tr>
                <th><?php echo $this->_var['lang']['rank_points']; ?>:</th>
                <td width="120"><?php echo $this->_var['shop_points']['rank_points']; ?></td>
              </tr>
            </table></td>
          </tr>
        </table>
...
?>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <th bgcolor="#FFFFFF"><?php echo $this->_var['lang']['rule']; ?></th>
            <th bgcolor="#FFFFFF"><?php echo $this->_var['lang']['transform_num']; ?></th>
            <th bgcolor="#FFFFFF"><?php echo $this->_var['lang']['transform_result']; ?></th>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF">
...
?>
          ...
          <td bgcolor="#FFFFFF"><span id="ECS_RESULT">0</span></td>
          </tr>
          <tr>
            <td colspan="3" align="center" bgcolor="#FFFFFF"><input type="hidden" name="act" value="act_transform_points"  /><input type="submit" value="<?php echo $this->_var['lang']['transform']; ?>" /></td>
          </tr>
        </table>
        </form>
       <script type="text/javascript">
