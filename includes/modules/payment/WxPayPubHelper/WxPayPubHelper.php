<?php
    ...
    class Wxpay_server_pub extends Common_util_pub
    {
        ...
        function checkSign()
        {
            ...
            $this->log( ROOT_PATH . '/data/wx_new_log.txt' , $sign_xml );//正确
            $this->log( ROOT_PATH . '/data/wx_new_log.txt' , 'pc:getSign:' . $sign );//错误
            $this->log( ROOT_PATH . '/data/wx_new_log.txt' , 'pc:sign:' . $this->data['sign'] );//正确
