...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here',       $_LANG['user_account']);
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link', array('href' => $href, 'text' => $_LANG['user_account']));
...
elseif ($_REQUEST['act'] == 'check')
{
    ...
    $smarty->assign('user_name',    $user_name);
    $smarty->assign('id',           $id);
    $smarty->assign('action_link',  array('text' => $_LANG['user_account'],
    'href'=>'user_account.php?act=list&' . list_link_postfix()));
