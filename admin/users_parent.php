...
//-- 用户帐号列表
    ...
    if ( $_REQUEST['act'] == 'list' ) {
        ...
        $smarty->assign( 'ur_here' , $_LANG['label_user_name'] );
...
//        $user['formated_frozen_money'] = price_format(0);
        ...
        $smarty->assign( 'action_link' , array( 'text' => $_LANG['goto_list'] , 'href' => 'users_parent.php?act=list&' . list_link_postfix() ) );
        $smarty->assign( 'user' , $user );
...
//-- 查看用户分销下线列表
    ...
    elseif ( $_REQUEST['act'] == 'share_list' ) {
        ...
        $smarty->assign( 'full_page' , 1 );
//        $smarty->assign( 'action_link' , array( 'text' => $_LANG['back_note'] , 'href' => "users.php?act=edit&id=$auid" ) );
        $smarty->assign( 'action_link' , array( 'text' => $_LANG['goto_list'] , 'href' => 'users_parent.php?act=list' ) );
