    ...
    if ( $_REQUEST['act'] == 'wxconfig' ) {
        ...
        if ( $_POST ) {
            ...
            foreach ( $ret as $k => $v ) {
                ...
                switch ( $v['cfg_name'] ) {
                    case 'murl':
                        $wxchdata[$k]['title'] = '手机站路径';
                        break;
                    case 'baseurl':
                        $wxchdata[$k]['title'] = '电脑版网址';
                        break;
                    case 'imgpath':
                        $wxchdata[$k]['title'] = '图片路径';
                        break;
                    case 'plustj':
                        $wxchdata[$k]['title'] = '搜索推荐';
                        break;
                    case 'userpwd':
                        $wxchdata[$k]['title'] = '默认密码';
                        break;
                    case 'cxbd':
                        $wxchdata[$k]['title'] = '重新绑定';
                        break;
                    case 'bd':
                        $wxchdata[$k]['title'] = '绑定会员模式';
                        break;
                    case 'oauth':
                        $wxchdata[$k]['title'] = '微信OAuth';
                        break;
                    case 'goods':
                        $wxchdata[$k]['title'] = '显示下架商品';
                        break;
                    case 'article':
                        $wxchdata[$k]['title'] = '文章路径';
                        break;
                    case 'q_name':
                        $wxchdata[$k]['title'] = '自定义会员名前缀';
                        break;
                    case 'tianxin_url':
                        $wxchdata[$k]['title'] = '分销引导关注URL';
                        break;
        ...
        foreach ( $ret as $k => $v ) {
            ...
            switch ( $v['lang_name'] ) {
                case 'regmsg':
                    $wxchdata[$k]['lang_name'] = '关注自动回复';
                    break;
                case 'help':
                    $wxchdata[$k]['lang_name'] = '帮忙说明';
                    break;
                case 'coupon':
                    $wxchdata[$k]['lang_name'] = '已经领取优惠卷';
                    break;
                case 'coupon1':
                    $wxchdata[$k]['lang_name'] = '优惠卷前言';
                    break;
                case 'coupon2':
                    $wxchdata[$k]['lang_name'] = '优惠卷送完';
                    break;
                case 'coupon3':
                    $wxchdata[$k]['lang_name'] = '优惠卷尾部';
                    break;
                case 'qdok':
                    $wxchdata[$k]['lang_name'] = '签到成功';
                    break;
                case 'qdno':
                    $wxchdata[$k]['lang_name'] = '签到数用完';
                    break;
                case 'qdstop':
                    $wxchdata[$k]['lang_name'] = '签到关闭';
                    break;
                case 'bd':
                    $wxchdata[$k]['lang_name'] = 'web模式绑定会员';
                    break;
                case 'goods':
                    $wxchdata[$k]['lang_name'] = '显示下架商品';
                    break;
                case 'prize_egg':
                    $wxchdata[$k]['lang_name'] = '砸金蛋抽奖规则';
                    break;
                case 'prize_dzp':
                    $wxchdata[$k]['lang_name'] = '大转盘抽奖规则';
                    break;
            }
        }
        $filter['record_count'] = $record_count;
        ...
        foreach ( $ret as $k => $v ) {
            ...
            switch ( $v['fun'] ) {
                case 'egg':
                    $wxchdata[$k]['fun_title'] = '砸金蛋';
                    break;
                case 'dzp':
                    $wxchdata[$k]['fun_title'] = '大转盘';
                    break;
            }
        }
        $filter['record_count'] = $record_count;
