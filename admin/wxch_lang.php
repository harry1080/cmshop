...
('$name', '$keyword', $type, '$p_title', '$path', '$summary', '$contents', 0, 1);" );
        ...
        if ( $_POST ) {
            ...
            switch ( $data['lang_name'] ) {
                case 'regmsg':
                    $data['lang_name'] = '关注自动回复';
                    break;
                case 'help':
                    $data['lang_name'] = '帮忙说明';
                    break;
                case 'coupon':
                    $data['lang_name'] = '已经领取优惠卷';
                    break;
                case 'coupon1':
                    $data['lang_name'] = '优惠卷前言';
                    break;
                case 'coupon2':
                    $data['lang_name'] = '优惠卷送完';
                    break;
                case 'coupon3':
                    $data['lang_name'] = '优惠卷尾部';
                    break;
                case 'qdok':
                    $data['lang_name'] = '签到成功';
                    break;
                case 'qdno':
                    $data['lang_name'] = '签到数用完';
                    break;
                case 'qdstop':
                    $data['lang_name'] = '签到关闭';
                    break;
                case 'bd':
                    $data['lang_name'] = 'web会员绑定';
                    break;
                case 'prize_egg':
                    $data['lang_name'] = '砸金蛋抽奖规则';
                    break;
            }
            $lang = array();
            $lang['tab_general'] = '主要信息';
