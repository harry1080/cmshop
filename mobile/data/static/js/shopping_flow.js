...
function orderShippingSelectedResponse(result)
{
  ...
  document.getElementById('selected1').innerHTML = result.shipping_name;
  ...
  try
  {
    if (document.getElementById('cod_fee') != undefined)
    {
      document.getElementById('cod_fee').innerHTML = result.cod_fee;
    }
  }
  catch (ex)
  {
