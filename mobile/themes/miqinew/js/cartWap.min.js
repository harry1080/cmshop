!function (t) {
    ...
    window.cartSys = {
        queryData: function (t) {
            ...
            var c = {};
            c.url = n.ADD_CART, c.data = d.buildAddCartQueryData(t, e), c.callback = function (t) {
        ...
        addProductToCart: function (t, e) {
            ...
            if (!r.default.isEmpty(t)) {
                ...
                $.each(t, function (t, e) {
                    ...
                    a += e.quantity
                }), cartObj.isCanAddCart(a, function (a) {

                    a ? new ecWap.ajax({
                        url: "/shoppingCart/add.json?",
                        type: "GET",
                        ...
                        successFunction: function (a) {
                            if (!a.success)return ecWap.alert(a.msg), !1;
