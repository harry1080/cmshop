...
//    require( dirname( __FILE__ ) . '/include/lib_license.php' );
//    require( dirname( __FILE__ ) . '/include/lib_goods.php' );
    ...
    function get_goods_list()
    {
        ...
        data_back( get_category_recommend_goods($_POST['type']) , '成功' , RETURN_TYPE );  //返回数据
    }
