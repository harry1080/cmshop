...
//-- 添加新包装
    ...
    if ( $_REQUEST['act'] == 'insert' ) {
        ...
        /*插入数据*/
        $sql = "INSERT INTO " . $ecs->table( 'pack' ) . "(pack_name, pack_fee, free_money, pack_desc, pack_img,hide)
            VALUES ('$_POST[pack_name]', '$_POST[pack_fee]', '$_POST[free_money]', '$_POST[pack_desc]', '$img_name','$_POST[hide]')";
        $db->query( $sql );
...
//-- 编辑包装
    ...
    if ( $_REQUEST['act'] == 'edit' ) {
        ...
        $sql = "SELECT pack_id, pack_name, pack_fee, free_money, pack_desc, pack_img,hide FROM " . $ecs->table( 'pack' ) . " WHERE pack_id='$_REQUEST[id]'";
        $pack = $db->GetRow( $sql );
    ...
    if ( $_REQUEST['act'] == 'update' ) {
        ...
        $param = "pack_name = '$_POST[pack_name]', pack_fee = '$_POST[pack_fee]', free_money= '$_POST[free_money]', pack_desc = '$_POST[pack_desc]' , hide = '$_POST[hide]'";
        /* 处理图片 */
...
//-- 删除包装
    ...
    function packs_list()
    {
        ...
        if ( $result === false ) {
            ...
            /* 查询 */
            $sql = "SELECT pack_id, pack_name, pack_img, pack_fee, free_money, pack_desc,hide" .
