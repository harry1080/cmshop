...
//    $modules['04_order']['02_order_list']               = 'order.php?act=list';
    ...
    $modules['11_system']['01_shop_config'] = 'shop_config.php?act=list_edit';//网站基本设置
...
//    $modules['11_system']['website']           = 'website.php?act=list';//第三方授权登陆

//    $modules['11_system']['user_card'] = 'user_card.php?act=ctlist';//会员卡
    ...
    //$modules['03_template']['02_template_select']       = 'template.php?act=list';
    $modules['03_template']['03_template_setup'] = 'template.php?act=setup';
    $modules['03_template']['04_template_library'] = 'template.php?act=library';
    $modules['03_template']['navigator'] = 'navigator.php?act=list';//菜单管理
    $modules['03_template']['ad_position'] = 'ad_position.php?act=list';//广告管理

//    $modules['03_template']['05_edit_languages']        = 'edit_languages.php?act=list';
    //$modules['03_template']['06_template_backup']       = 'template.php?act=backup_setting';
    //$modules['03_template']['mail_template_manage']     = 'mail_template.php?act=list';
...
//    $modules['02_rec']['affiliate'] = 'affiliate.php?act=list';//推荐设置
//    $modules['02_rec']['affiliate_ck'] = 'affiliate_ck.php?act=list';//分成管理
//    $modules['02_rec']['danpin_tuiguang'] = 'article_tianxin100.php?act=list';//单品推广
//    $modules['02_rec']['zdy_parent'] = 'users_parent.php?act=list';//推荐关系
    ...
    //微信通管理
    $modules['01_wechat']['wx_22api'] = 'wxch-ent.php?act=wxconfig';//微信接口
////    $modules['01_wechat']['wx_21menu'] = 'wxch-ent.php?act=menu';             //微信菜单
    $modules['01_wechat']['wx_20config'] = 'wxch-ent.php?act=config';      //微信通设置
    $modules['01_wechat']['wx_19autoreg'] = 'wxch-ent.php?act=autoreg';    //微信自动登录
//    $modules['01_wechat']['wx_18bonus'] = 'wxch-ent.php?act=bonus';        //送红包
//    $modules['01_wechat']['wx_17regmsg'] = 'wxch-ent.php?act=regmsg';      //自动注册
//    $modules['01_wechat']['wx_23lang'] = 'wxch-ent.php?act=lang';          //语言设置
//    $modules['01_wechat']['wx_16keywords'] = 'wxch-ent.php?act=keywords';  //关键词自动回复
//    $modules['01_wechat']['wx_00point'] = 'wxch-ent.php?act=point';      //增加积分
//    $modules['01_wechat']['wx_14fun'] = 'wxch-ent.php?act=fun';            //功能变量
//    $modules['01_wechat']['wx_01prize'] = 'wxch-ent.php?act=prize';    //抽奖规则
//    $modules['01_wechat']['wx_03zjd'] = 'wxch-ent.php?act=zjd';            //砸金蛋
//    $modules['01_wechat']['wx_02dzp'] = 'wxch-ent.php?act=dzp';            //大转盘
////    $modules['01_wechat']['wx_10qr'] = 'wxch-ent.php?act=qr';          //多功能二维码
//    $modules['01_wechat']['wx_09order'] = 'wxch-ent.php?act=order';    //发货提醒
//    $modules['01_wechat']['wx_08pay'] = 'wxch-ent.php?act=pay';        //付款提醒
//    $modules['01_wechat']['wx_07reorder'] = 'wxch-ent.php?act=reorder';    //订单提醒
//    $modules['01_wechat']['wx_06fans'] = 'wxch_users.php?act=list';    //粉丝管理
//    $modules['01_wechat']['wx_15oauth'] = 'wxch-ent.php?act=oauth';        //微信OAuth
//    $modules['01_wechat']['wx_04tuijian'] = 'wxch-ent.php?act=tuijian'; //扫码引荐
//    $modules['01_wechat']['wx_11tuijian_reply'] = 'wxch-ent.php?act=tuijian_reply';//发展会员关注提醒
//    $modules['01_wechat']['wx_05list'] = 'users_invite.php?act=list';//推荐人列表
//    //教程
