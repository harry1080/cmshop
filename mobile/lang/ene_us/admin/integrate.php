...
/**
 * The 云动商圈Control panel member the data integration plug-in management program language file
 * ============================================================================
 * All right reserved (C) 2005-2011 Beijing Yi Shang Interactive Technology
 * Development Ltd.
 * Web site: http://www.mbizzone.com
 * ----------------------------------------------------------------------------
...
$_LANG['need_not_setup'] = 'You needn\`t set wehn you use 云动商圈systerm';
$_LANG['neednot_sync'] ='You needn\'t synchronous operation, beacuse the 云动商圈member system is in use now.';
$_LANG['different_domain'] ='The integration object and 云动商圈of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
