...
$_LANG['can_use_integral'] = '剩余积分';
$_LANG['noworder_can_integral'] = '积分使用上限';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.mbizzone.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
