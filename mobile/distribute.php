...
*/
    ...
    require( dirname( __FILE__ ) . '/include/lib_weixintong.php' );
    /* 载入语言文件 */
    ...
    */
    ...
    elseif ( $action == 'account_raply' ) {
        ...
        if ( !$_POST['bind'] ) {
            ...
            $limit_account_replay = $db->getOne( "select limit_account_replay from " . $ecs->table( 'users' ) . " where user_id = $user_id" );
